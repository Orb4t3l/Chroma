...
public final class MacawsFurnitureCompat {
    ...
    private static final String[] COLORED_TYPES = { "couch", "chaise" };

    private MacawsFurnitureCompat() {}

    public static void register() {
        for (String type : COLORED_TYPES) {
            for (String color : COLORS) {
                registerItem("mcwfurnitures:" + color + "_" + type,
